            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="#">&Oacute;mosis Inversa</a></li>
                  <li><a href="#">Ozono</a></li>
                  <li><a href="#">Ultravioleta</a></li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="#">Sartenes</a></li>
                  <li><a href="#">Cacerolas</a></li>
                  <li><a href="#">Asadores el&eacute;ctricos</a></li>
                  <li role="separator" class="divider"></li>
                  <li><a href="#">Set de cubiertos</a></li>
                  <li><a href="#">Set de ollas</a></li>
                </ul>
              </li>
            </ul>
